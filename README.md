...
### ✈️ [ATL Flight Disruption Model](https://github.com/arin-deshpande/ATL-Flight-Disruption-Model)
...
A mobile stock tracker: search any ticker, get live quotes from the Finnhub API, and build a watchlist.
`React Native` `Expo` `JavaScript`

## Tools

**Data:** Python, pandas, NumPy, scikit-learn, Matplotlib, SQL (SQLite), Jupyter<br>
**Web & mobile:** JavaScript, React, React Native, Expo, Vite<br>
**Other:** Git, GitHub Actions, Google Colab

## Connect

[LinkedIn](https://www.linkedin.com/in/arin-deshpande/)
